...
description: "Use when generating ideas (features, designs, names, architectures, stuck problems), interrupting the rush to the first plausible idea, or preparing real alternatives for a decision — inversion, SCAMPER, analogy."
---
