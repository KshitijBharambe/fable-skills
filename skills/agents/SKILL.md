---
name: agents
description: "Use when building an LLM agent (model + tools + loop), choosing between a fixed workflow and an agent, fixing unreliable agents (wrong tools, runaway loops, goal drift), or designing tools/memory/multi-agent topologies."
---
