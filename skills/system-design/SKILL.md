---
name: system-design
description: "Use when designing a new service or backend, scaling a system near its limits, evaluating architecture proposals (microservices, datastores, rewrites), or in system-design interviews — meet the actual QPS/latency/availability numbers."
---
