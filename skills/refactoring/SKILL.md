---
name: refactoring
description: "Use when code's shape resists a change ('make the change easy, then make the easy change'), the same bug family recurs, before extending code you don't understand, or a working PR deepens a structural problem — behavior-preserving."
---
