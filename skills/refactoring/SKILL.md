---
name: refactoring
description: "Use when code's shape resists a change, the same bug family recurs, before extending code you don't understand, changing systems with thin tests and departed authors, running any migration (database, framework, v1-to-v2), or when 'let's just rewrite it' comes up."
---
