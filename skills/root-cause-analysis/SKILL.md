...
description: "Use when a bug's cause isn't obvious, a 'fixed' bug came back, chasing 'works on my machine,' or vetting a fix that can't explain the mechanism — reproduce, minimize, hypothesize, binary-search."
---
