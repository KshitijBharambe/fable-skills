...
description: "Use when any service calls another service/DB/API, designing failure behavior for a dependency, after a cascade or retry-storm outage, or reviewing network calls with no timeout — timeouts, retries with jitter, circuit breakers, backpressure, graceful degradation."
---
