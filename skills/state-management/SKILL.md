...
description: "Use when choosing frontend state architecture, a global store became a dumping ground, data is stale/duplicated/flickering, or deciding on Redux/Zustand/Jotai/signals vs a server-cache library — server vs URL vs local vs global."
---
