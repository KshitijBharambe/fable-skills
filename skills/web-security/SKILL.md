---
name: web-security
description: "Use when designing any endpoint/form/upload/webhook touching untrusted input, reviewing code that crosses a trust boundary, threat-modeling features (money, PII, auth, files), or fixing a pentest finding by class."
---
