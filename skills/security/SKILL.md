---
name: security
description: "Use when designing any endpoint/form/upload/webhook touching untrusted input, threat-modeling features (money, PII, auth, files), fixing a pentest finding by class, handling a created or leaked credential, adding/auditing dependencies, or designing CI/CD secret handling."
---
