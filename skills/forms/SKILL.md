---
name: forms
description: "Use when building any input surface (signup, checkout, settings, wizards, inline/bulk edits), fixing lost input or abandonment, mapping server errors to fields, or choosing a form library — validation timing, accessibility."
---
