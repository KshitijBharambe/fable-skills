---
name: authorization
description: "Use when adding roles, permissions, sharing, or multi-tenant isolation, securing resource-by-ID endpoints (IDOR), or refactoring scattered inline access checks — RBAC, ABAC, ReBAC, fail-closed enforcement."
---
