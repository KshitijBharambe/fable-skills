---
name: event-driven
description: "Use when designing event-based systems (event schemas, sagas, CQRS, eventual consistency), coordinating cross-service workflows without distributed transactions, or reviewing dual-write / 'just publish an event' designs."
---
