...
description: "Use when building business logic (pricing, eligibility, lifecycles, workflows), the same rule lives in three drifting places, controllers grew hundreds of ifs, or 'impossible state' bugs recur — value objects, state machines, invariants, where logic lives."
---
