---
name: api-design
description: "Use when designing a new HTTP/RPC API or adding endpoints, choosing REST vs GraphQL vs gRPC, reviewing an API/OpenAPI spec, or fixing an 'awkward' API — resource modeling, errors, pagination, versioning, compatibility."
---
