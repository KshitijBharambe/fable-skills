...
description: "Use when an alert fires or users report an outage, a deploy 'feels off,' chasing intermittent production-only failures, or converting a mitigation into root cause — stabilize first, preserve evidence, run the incident."
---
